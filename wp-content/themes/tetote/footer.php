      ...
      <div class="footer__body-upper">
        <div class="footer__logo md-show">
          <a href="<?php echo esc_url(home_url('/')); ?>" class="footer__logo-link">
            <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/title-black.svg')); ?>" alt="タイトルロゴ" class="footer__logo-img">
          </a>
        </div>
        ...
        <ul class="footer__sns-items">
          <li class="footer__sns-item">
            <a href="" class="footer__sns-link">
              <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/facebook-icon.svg')); ?>" alt="フェースブックのアイコン" class="footer__sns-img">
            </a>
          </li>
          <li class="footer__sns-item">
            <a href="" class="footer__sns-link">
              <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/twitter-icon.svg')); ?>" alt="ツイッターのアイコン" class="footer__sns-img">
            </a>
          </li>
          <li class="footer__sns-item">
            <a href="" class="footer__sns-link">
              <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/yutube-icon.svg')); ?>" alt="ユーチューブのアイコン" class="footer__sns-img">
            </a>
          </li>
        </ul>
